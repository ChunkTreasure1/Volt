...
inline void DrawIconKey(ImDrawList* drawList, const ImVec2& a, const ImVec2& b, IconType type, bool filled, ImU32 color, ImU32 innerColor)
{
...
inline void DrawPinIcon(const GraphKey::Attribute& pin, bool connected, ImColor color, int32_t alpha)
{
	IconType iconType;
	switch (pin.type)
	{
