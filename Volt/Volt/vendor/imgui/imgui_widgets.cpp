...
bool ImGui::ImageButtonAnimated(ImTextureID user_texture_id, ImTextureID texId, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, int frame_padding, const ImVec4& bg_col, const ImVec4& tint_col)
{
    ImGuiContext& g = *GImGui;
    ImGuiWindow* window = g.CurrentWindow;
    if (window->SkipItems)
...
bool    ImGui::TabItemEx(ImGuiTabBar* tab_bar, const char* label, bool* p_open, ImGuiTabItemFlags flags, ImGuiWindow* docked_window)
{
    ...
    const ImU32 tabTopCol = GetColorU32((held || hovered) ? ((tab_contents_visible && tab_bar_focused) ? ImGuiCol_TabTop : ImGuiCol_TabHovered) : tab_contents_visible ? (tab_bar_focused ? ImGuiCol_TabTop : ImGuiCol_TabUnfocusedActive) : (tab_bar_focused ? ImGuiCol_Tab : ImGuiCol_TabUnfocused));
    display_draw_list->AddRectFilled(bb.Min, { bb.Max.x, bb.Max.y - 22.f }, tabTopCol);
