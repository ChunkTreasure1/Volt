...
enum ImGuiWindowFlags_
{
    ...
    //VOLT_SOURCE_MODIFICATION_BEGIN: Volt specific flags
    ImGuiWindowFlags_NoTabBar = 1 << 30
    //VOLT_SOURCE_MODIFICATION_ENDb 
};
...
//VOLT_SOURCE_MODIFICATION_BEGIN: This was removed from the original imgui.h file, adds the things like ImGui::Spring()
