...
static void ShowDemoWindowWidgets()
{
	...
	if (ImGui::TreeNode("Multi-component Widgets"))
	{
		...
		static int ivec4[4] = { 1, 5, 100, 255 };

		ImGui::InputFloat2("input float2", vec4f);
		ImGui::DragFloat2("drag float2", vec4f, 0.01f, 0.0f, 1.0f);
		ImGui::SliderFloat2("slider float2", vec4f, 0.0f, 1.0f);
		ImGui::InputInt2("input int2", ivec4);
		ImGui::DragInt2("drag int2", ivec4, 1, 0, 255);
		ImGui::SliderInt2("slider int2", ivec4, 0, 255);
		ImGui::Spacing();

		ImGui::InputFloat3("input float3", vec4f);
		ImGui::DragFloat3("drag float3", vec4f, 0.01f, 0.0f, 1.0f);
		ImGui::SliderFloat3("slider float3", vec4f, 0.0f, 1.0f);
		ImGui::InputInt3("input int3", ivec4);
		ImGui::DragInt3("drag int3", ivec4, 1, 0, 255);
		ImGui::SliderInt3("slider int3", ivec4, 0, 255);
		ImGui::Spacing();

		ImGui::InputFloat4("input float4", vec4f);
		ImGui::DragFloat4("drag float4", vec4f, 0.01f, 0.0f, 1.0f);
		ImGui::SliderFloat4("slider float4", vec4f, 0.0f, 1.0f);
		ImGui::InputInt4("input int4", ivec4);
		ImGui::DragInt4("drag int4", ivec4, 1, 0, 255);
		ImGui::SliderInt4("slider int4", ivec4, 0, 255);
