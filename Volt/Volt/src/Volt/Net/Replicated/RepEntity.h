...
namespace Volt
{
	...
	{
	public:
		RepEntity(Volt::EntityID in_entityId, Nexus::TYPE::CLIENT_ID in_ownerId, Volt::AssetHandle in_handle, bool preplaced = false)
		...
		const Volt::EntityID GetEntityId() const { return m_entityId; }
