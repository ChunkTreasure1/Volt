...
namespace Volt
{
	struct CharacterControllerComponent
	{
		...
		inline CharacterControllerComponent(ClimbingMode aClimbingMode = ClimbingMode::Normal, float aSlopeLimit = 20.f, float aInvisibleWallHeight = 2.f, float aMaxJumpHeight = 1.f,
			float aContactOffset = 0.01f, float aStepOffset = 0.1f, float aDensity = 1.f, uint32_t aLayer = 0, bool aHasGravity = true)
		...
		static void ReflectType(TypeDesc<CharacterControllerComponent>& reflect)
		{
			...
			reflect.AddMember(&CharacterControllerComponent::invisibleWallHeight, "invisibleWallHeight", "Invisible Wall Height", "", 2.f);
			reflect.AddMember(&CharacterControllerComponent::maxJumpHeight, "maxJumpHeight", "Max Jump Height", "", 1.f);
			reflect.AddMember(&CharacterControllerComponent::contactOffset, "contactOffset", "Contact Offset", "", 0.01f);
			reflect.AddMember(&CharacterControllerComponent::stepOffset, "stepOffset", "Step Offset", "", 0.1f);
	...
	struct BoxColliderComponent
	{
		...
		inline BoxColliderComponent(const glm::vec3& aHalfSize = { 0.5f, 0.5f, 0.5f }, const glm::vec3& aOffset = { 0.f }, bool aIsTrigger = false, AssetHandle aMaterial = Asset::Null())
		...
		static void ReflectType(TypeDesc<BoxColliderComponent>& reflect)
		{
			...
			reflect.AddMember(&BoxColliderComponent::halfSize, "halfSize", "Half Size", "", glm::vec3{ 0.5f });
	...
	struct SphereColliderComponent
	{
		...
		inline SphereColliderComponent(float aRadius = 0.5f, const glm::vec3& aOffset = { 0.f }, bool aIsTrigger = false, AssetHandle aMaterial = Asset::Null())
		...
		static void ReflectType(TypeDesc<SphereColliderComponent>& reflect)
		{
			...
			reflect.AddMember(&SphereColliderComponent::radius, "radius", "Radius", "", 0.5f);
	...
	struct CapsuleColliderComponent
	{
		...
		inline CapsuleColliderComponent(float aRadius = 0.5f, float aHeight = 0.5f, const glm::vec3& aOffset = { 0.f }, bool aIsTrigger = false, AssetHandle aMaterial = Asset::Null())
		...
		static void ReflectType(TypeDesc<CapsuleColliderComponent>& reflect)
		{
			...
			reflect.AddMember(&CapsuleColliderComponent::radius, "radius", "Radius", "", 0.5f);
			reflect.AddMember(&CapsuleColliderComponent::height, "height", "Height", "", 0.5f);
