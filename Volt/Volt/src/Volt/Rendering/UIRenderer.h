...
namespace Volt
{
	...
	public:
		...
		static void DrawSprite(Ref<Image2D> image, const gem::vec3& position, const gem::vec2& scale, float rotation, const gem::vec4& color = 1.f, const gem::vec2& offset = 0.f);
		...
		static void DrawString(const std::string& text, const Ref<Font> font, const gem::vec3& position, const gem::vec2& scale, float rotation, float maxWidth, const gem::vec4& color, const gem::vec2& positionOffset);
