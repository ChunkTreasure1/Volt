...
namespace Volt
{
	...
	public:
		...
		static void Begin(Ref<RHI::Image2D> renderTarget);
		static void End();
		...
		static void DrawSprite(Ref<RHI::Image2D> image, const glm::vec3& position, const glm::vec2& scale, float rotation, const glm::vec4& color = 1.f, const glm::vec2& offset = 0.f);
