...
namespace Volt
{
	...
	class RenderGraphNullHandle : public RenderGraphResourceHandle
	{
	public:
	...
	class RenderGraphBufferHandle : public RenderGraphResourceHandle 
	{
	public:
	...
	class RenderGraphUniformBufferHandle : public RenderGraphResourceHandle 
	{
	public:
	...
	class RenderGraphImage2DHandle : public RenderGraphResourceHandle 
	{
	public:
	...
	class RenderGraphImage3DHandle : public RenderGraphResourceHandle 
	{
	public:
