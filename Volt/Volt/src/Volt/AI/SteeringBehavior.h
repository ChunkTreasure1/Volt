...
namespace Volt
{
	...
	public:
		...
		static gem::vec3 Wander(Entity agent, gem::vec3 direction, float wanderRadius, float wanderOffset);
		static gem::vec3 Separation(Entity agent, float radius);

	private:
		// Make public when implemented.
