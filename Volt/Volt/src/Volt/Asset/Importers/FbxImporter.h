...
namespace Volt
{
	...
	protected:
		...
		void ExportSkeletonImpl(Vector<Ref<Skeleton>> assets, const std::filesystem::path&) override {};
		void ExportAnimationImpl(Vector<Ref<Animation>> assets, const std::filesystem::path&) override {};
