...
#pragma region UIRenderer
	...
	inline static void UIRenderer_DrawString(MonoString* text, uint64_t fontHandle, glm::vec3* position, glm::vec2* scale, float rotation, float maxWidth, glm::vec4* color)
	{
