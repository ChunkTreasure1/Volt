...
#define VT_REGISTER_SCRIPT(x) static bool x ## _entry = Volt::ScriptRegistry::Register(x::GetStaticGUID(), Volt::ScriptMetadata{ #x, [](Volt::Entity entity) -> Ref<Volt::Script> { return CreateRef<x>(entity); }});
