...
ACC_NAMESPACE_BEGIN
VT_DISABLE_WARNING(4244 4267 4456 4457)
...
public:
	...
	BVHTree(std::span<const IdxType> faces,
		std::span<const Vec3fType> vertices,
		int max_threads = std::thread::hardware_concurrency());
...
template <typename IdxType, typename Vec3fType>
BVHTree<IdxType, Vec3fType>::BVHTree(std::span<const IdxType> faces,
	std::span<const Vec3fType> vertices, int max_threads) : num_nodes(0)
{
