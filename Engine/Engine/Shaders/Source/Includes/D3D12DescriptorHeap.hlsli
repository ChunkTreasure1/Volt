...
#define DEFINE_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, valueType, handleName, validationType) \
    ...
    { \
        ...
        return ResourceDescriptorHeap[NonUniformResourceIndex(GetHandle(identifier.handle))]; \
    } \

#define DEFINE_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL_MULTI(resourceType, validationType) \
    DEFINE_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, float, resourceType##Handle, validationType) \
    DEFINE_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, float2, resourceType##Handle, validationType) \
    DEFINE_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, float3, resourceType##Handle, validationType) \
    DEFINE_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, float4, resourceType##Handle, validationType) \
    DEFINE_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, uint, resourceType##Handle, validationType) \
    DEFINE_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, uint2, resourceType##Handle, validationType) \
    DEFINE_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, uint3, resourceType##Handle, validationType) \
    DEFINE_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, uint4, resourceType##Handle, validationType) \


#define DEFINE_UNIFORM_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, valueType, handleName, validationType) \
    resourceType<valueType> operator[](handleName<valueType> identifier) \
    { \
        ValidateResourceAccess(GetHandleType(identifier.handle), validationType); \
        return ResourceDescriptorHeap[GetHandle(identifier.handle)]; \
    } \

#define DEFINE_UNIFORM_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL_MULTI(resourceType, validationType) \
    DEFINE_UNIFORM_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, float, resourceType##Handle, validationType) \
    DEFINE_UNIFORM_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, float2, resourceType##Handle, validationType) \
    DEFINE_UNIFORM_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, float3, resourceType##Handle, validationType) \
    DEFINE_UNIFORM_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, float4, resourceType##Handle, validationType) \
    DEFINE_UNIFORM_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, uint, resourceType##Handle, validationType) \
    DEFINE_UNIFORM_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, uint2, resourceType##Handle, validationType) \
    DEFINE_UNIFORM_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, uint3, resourceType##Handle, validationType) \
    DEFINE_UNIFORM_TEXTURE_TYPE_TEMPLATE_SPECIALIZATION_DECL(resourceType, uint4, resourceType##Handle, validationType) \
