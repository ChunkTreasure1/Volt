...
RWStructuredBuffer<IndirectGPUBatch> u_indirectBatches : register(BINDING_INDIRECT_ARGS, SPACE_RENDERER_BUFFERS);
...
StructuredBuffer<float4> u_paintedVertexColors : register(BINDING_PAINTED_VERTEX_COLORS, SPACE_RENDERER_BUFFERS);
