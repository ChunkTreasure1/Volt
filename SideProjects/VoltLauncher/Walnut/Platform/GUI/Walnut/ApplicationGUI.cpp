...
#include "Walnut/Embed/WindowImages.embed"
	...
	void Application::Init()
	{
		...
		s_Fonts["BoldHeader"] = io.Fonts->AddFontFromMemoryTTF((void*)g_RobotoBold, sizeof(g_RobotoBold), 40.f, &fontConfig);
		...
		// Load images
		{
			m_AppHeaderIcon = std::make_shared<Walnut::Image>("Icons/icon_volt.png");
		}
		{
			uint32_t w, h;
